        ...
        <div>
          ...
          <ul className="space-y-2 text-green-100 text-sm">
            <li className="flex items-center gap-2">
              <MapPin size={16} /> NITK, Surathkal
            </li>
            <li className="flex items-center gap-2">
              <Phone size={16} /> +91 7978996862
            </li>
            <li className="flex items-center gap-2">
              <Mail size={16} /> asherushare@gmail.com
            </li>
          </ul>
          {/* 🌐 Social Links */}
          <div className="flex gap-4 mt-4">
            <Link
              href="https://www.linkedin.com/in/asherushare/"
              target="_blank"
            >
              <Linkedin className="w-5 h-5 hover:text-white transition" />
            </Link>
            <Link href="https://github.com/asherushare" target="_blank">
              <Github className="w-5 h-5 hover:text-white transition" />
            </Link>
            <Link href="https://x.com/asherushare" target="_blank">
