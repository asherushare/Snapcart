...
function UserOrderCard({ order }: { order: IOrder }) {
  const normalizeStatus = (value: string) =>
    value === "out of delivery" ? "out for delivery" : value;
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border border-gray-100 px-5 py-4 bg-linear-to-r from-green-50 to-white">
        <div>
