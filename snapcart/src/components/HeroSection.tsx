    ...
    const slides = [
      {
        ...
        btnText: "Shop Now",
        bg: "https://images.unsplash.com/photo-1593759608329-a8247d4f5e49?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
      {
        id: 2,
        icon: (
        ...
        subtitle: "We ensure your groceries reach your doorstep on time.",
        btnText: "Order Now",
        bg: "https://images.unsplash.com/photo-1695653422259-8a74ffe90401?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
      {
        id: 3,
        icon: (
          <Leaf className="w-20 h-20 sm:w-28 text-blue-400 drop-shadow-lg" />
        ),
        title: "Shop anytime, anywhere 🛒",
        subtitle: "Easy and seamless online grocery shopping experience.",
        btnText: "Get Started",
        bg: "https://images.unsplash.com/photo-1753354868656-53671f69602a?q=80&w=1331&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
    ];
    ...
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
      <AnimatePresence mode='wait'>
        ...
        >
          ...
          fill alt='slide' priority className='object-cover' />
